 ...
 */
package com.shanghaitimes.tweetr
{
    import com.shanghaitimes.tweetr.data.DataParser;
    import com.shanghaitimes.tweetr.data.objects.CursorData;
    import com.shanghaitimes.tweetr.events.TweetEvent;
    import com.shanghaitimes.tweetr.oauth.IOAuth;
	 ...
	 * @eventType com.shanghaitimes.tweetr.events.TweetEvent.COMPLETE
	 */ 
    [Event(name="complete", type="com.shanghaitimes.tweetr.events.TweetEvent")]
    /**
     * Dispatched when something goes wrong while trying to request something from twitter
     * @eventType com.shanghaitimes.tweetr.events.TweetEvent.FAILED
     */ 
    [Event(name="failed", type="com.shanghaitimes.tweetr.events.TweetEvent")]
    /**
     * Merely for Informational purposes. Dispatches the http status to the listener
     * @eventType com.shanghaitimes.tweetr.events.TweetEvent.STATUS
     */ 
    [Event(name="status", type="com.shanghaitimes.tweetr.events.TweetEvent")]
    ...
    public class Tweetr extends EventDispatcher
    {
		...
		private static const DATA_FORMAT:String = "json";    // was xml
         ...
         public function updateStatus(status:String, inReplyTo:String = null, lat:Number = 0, long:Number = 0):URLRequest
        {
            ...
            checkCredentials();
            _returnType = RETURN_TYPE_STATUS;
            trace("In Tweetr.as, Line 518: Returns:" + status);
			// which is what you are posting to your timeline...
